...
train = np.load(
    DATA_DIR / "train_prepared.npz"
)

val = np.load(
    DATA_DIR / "validation_prepared.npz"
)
...
print("========================================")
print("RESIDUAL ST-GNN TRAINING")
print("========================================")
...
print("Residual Y:", tuple(Y_train.shape))

print("\nValidation:")
print("X:", tuple(X_val.shape))
print("Residual Y:", tuple(Y_val.shape))
...
history_df.to_csv(
    DATA_DIR /
    "residual_stgnn_training_history.csv",
    index=False
)

print("\n========================================")
print("RESIDUAL ST-GNN TRAINING COMPLETE")
print("========================================")
...
print(
    f"Best validation : {best_val_loss:.6f}"
)
