...
MISMATCH_CSV = Path(
    "data/processed/fire_station_ward_mismatches.csv"
)

OUT_GEOJSON = Path(
    "data/spatial/mumbai_fire_stations_validated.geojson"
)
...
def main():
    ...
    # GIS-derived ward is the authoritative spatial assignment
    ...
    print("\nFire Stations GIS Validation")
    print("--------------------------------")

    print(
        f"Coordinate-valid stations: {len(joined)}"
    )
